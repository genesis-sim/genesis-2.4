...
//
// This demo maps out parameter space for a simple cell model using the
// brute-force (BF) parameter search method.  The cell is a simple
// one-compartment cell with three ionic conductances.  A series

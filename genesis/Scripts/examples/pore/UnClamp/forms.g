...
setfield /patch/K Gmax {KGmax}
setfield /patch/Na Gmax {NaGmax}
setfield /patch/K Nt {numK}
setfield /patch/Na Nt {numNa}
...
create xdialog tstep [10,80,255,25] -value 100.0 -title "time (msec)"  \
    -script void
create xdialog dt [10,115,255,25] -value 0.1 -title "dt (msec)" -script  \
    "set_dt"
...
create xdialog level [10,45,255,25] -value 0.00 -title  \

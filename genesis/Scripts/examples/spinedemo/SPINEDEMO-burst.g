...
/* create output */
     ...
     setfield /output/file filename "Spine_burst" initialize 1 leave_open 1
...
/* create graphics */
	...
	"synaptic conductance" bg white
     ...
     setfield /results/synapse xmax 0.3 ymin 0 ymax 2.0e-11
	...
	-title "calcium concentration" bg white
     ...
     setfield /results/calcium xmax 0.3 ymin 0.00001 ymax 0.035
...
step 0.010 -time
echo "Firing synapse at 200 Hz (8 impulses)"
setfield /solve/presyn z 1
step 1

...
str script_name = "W5ex-5-1-default.g" 
str RUNID = "5100G2"        // default ID string for output file names

// Full graphics

/* Some Booleans indicating the type of calculations or output */
int batch = 0        // if (batch) then run a default simulation
int graphics = 2     // if = 1, display control panel minimal graphs
                     // if = 2, show more detailed output (much slower)
int file_out = 0     // write output to a file
int weights_out = 0  // output weights to a file
...
float Inh_gmax   = 0.0e-9 // max Inh conductance
...
str Vm_file = "W5ex_Vm"
str syn_file = "W5ex_Gk_I"
str weights_file = "W5ex_weights"
str sum_file = "run_summary"

float tmax = 100.0                // simulation time in sec

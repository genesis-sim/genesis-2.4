/*
** 2000-09-21 <mhucka@caltech.edu>
** Including this into GENESIS for platforms that do not provide an
** alloca() function.  This file was taken almost in its entirety
** from XEmacs 21.1.8.  The following headers are original, but the
** version control logs are ours for GENESIS, and there have been a
** few small code changes needed to get it to compile with GENESIS.
**
** $Log: alloca.c,v $
** Revision 1.1.1.1  2005/06/14 04:38:33  svitak
** Import from snapshot of CalTech CVS tree of June 8, 2005
**
** Revision 1.2  2000/10/09 23:00:17  mhucka
** Portability fixes for AIX.
**
** Revision 1.1  2000/09/21 19:24:57  mhucka
...
/*
** This is only compiled in for those systems that actually need it.
*/
#ifdef NEED_ALLOCA
...
static void dummy()
{
  /* Dummy to prevent compilers from complaining about an empty file. */
}

...
********************************************************************/
/* $Id: netcdf_ext.h,v 1.1.1.1 2005/06/14 04:38:29 svitak Exp $ */
/*
 * $Log: netcdf_ext.h,v $
 ...
 *
 * Revision 1.4  1998/01/15 02:31:13  venkat
 * Hardcoded inclusion of abstract interface headers replaced by direct
 * inclusion. Made possible by the -I.. option to CC in the Makefile
 *
 * Revision 1.3  1998/01/14 18:35:03  venkat
 * Change in the #includes for the abstract interface headers to
...
#include "netcdf.h" /*Netcdf Library header */

#include "absff_header.h"
#include "absff_struct.h"
#include "netcdf_struct.h"

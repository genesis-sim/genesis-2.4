static char rcsid[] = "$Id: peristim.c,v 1.3 2005/07/01 10:03:01 svitak Exp $";
...
void PeriStimulusDistribution(count,action)
register struct peristim_type *count;
Action		*action;
{
	MsgIn	*msg;
	float   voltage = 0.0,time;

...
//	orient2 example (same as demo.g except n_slices == 1)

// parameters for this run
int n_slices = 1	// 1 slices
...
// $Log: 1slice.g,v $
// Revision 1.1  2006/02/03 17:25:25  ghood
// Added for consistency with Hyperdoc documentation
//
